...
SECRET_KEY = os.environ.get('SECRET_KEY', "django-insecure-n!wb187lnn(*yad=b6gj$+*yx!!ia_!o1$5id97w%bwi_n-x_v")
...
# Database: SQLite pour tous les environnements (local et Render)
DATABASES = {
    "default": {
